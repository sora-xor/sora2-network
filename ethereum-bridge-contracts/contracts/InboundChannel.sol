...
contract InboundChannel is Ownable, ReentrancyGuard {
    ...
    function submit(
        ...
        bytes32 digestHash = keccak256(
            abi.encode(block.chainid.encode256(), commitment)
        );

        require(verifySignatures(digestHash, v, r, s), "Invalid signatures");
    ...
    function verifySignatures(
        ...
        require(signatureCount == r.length, "v and r length mismatch");
        require(signatureCount == s.length, "v and s length mismatch");
