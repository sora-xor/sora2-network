...
// EncodeMMRLeaf is a free data retrieval call binding the contract method 0xc4fa19a8.
//
// Solidity: function encodeMMRLeaf((uint8,uint32,bytes32,bytes32,uint64,uint32,bytes32,bytes32) leaf) pure returns(bytes)
...
// CompleteSignatureCommitment is a paid mutator transaction binding the contract method 0x091d0555.
//
// Solidity: function completeSignatureCommitment(uint256 id, (bytes32,uint64,uint32) commitment, (bytes[],uint256[],address[],bytes32[][]) validatorProof, (uint8,uint32,bytes32,bytes32,uint64,uint32,bytes32,bytes32) latestMMRLeaf, uint64 leafIndex, uint64 leafCount, bytes32[] mmrProofItems) returns()
...
// VerifyNewestMMRLeaf is a paid mutator transaction binding the contract method 0x16f76a97.
//
// Solidity: function verifyNewestMMRLeaf((uint8,uint32,bytes32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] proof, bytes32 root, uint64 leafIndex, uint64 leafCount) returns()
