...
// IncentivizedInboundChannelLeafBytes is an auto generated low-level Go binding around an user-defined struct.
type IncentivizedInboundChannelLeafBytes struct {
	DigestPrefix []byte
	DigestSuffix []byte
	LeafPrefix   []byte
}
...
// Submit is a paid mutator transaction binding the contract method 0x5b1ce5e1.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, (bytes,bytes,bytes) _leafBytes, uint256 _beefyMMRLeafIndex, uint256 _beefyMMRLeafCount, bytes32[] _beefyMMRLeafProof) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelTransactor) Submit(opts *bind.TransactOpts, _messages []IncentivizedInboundChannelMessage, _leafBytes IncentivizedInboundChannelLeafBytes, _beefyMMRLeafIndex *big.Int, _beefyMMRLeafCount *big.Int, _beefyMMRLeafProof [][32]byte) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.contract.Transact(opts, "submit", _messages, _leafBytes, _beefyMMRLeafIndex, _beefyMMRLeafCount, _beefyMMRLeafProof)
}

// Submit is a paid mutator transaction binding the contract method 0x5b1ce5e1.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, (bytes,bytes,bytes) _leafBytes, uint256 _beefyMMRLeafIndex, uint256 _beefyMMRLeafCount, bytes32[] _beefyMMRLeafProof) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelSession) Submit(_messages []IncentivizedInboundChannelMessage, _leafBytes IncentivizedInboundChannelLeafBytes, _beefyMMRLeafIndex *big.Int, _beefyMMRLeafCount *big.Int, _beefyMMRLeafProof [][32]byte) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.Contract.Submit(&_IncentivizedInboundChannel.TransactOpts, _messages, _leafBytes, _beefyMMRLeafIndex, _beefyMMRLeafCount, _beefyMMRLeafProof)
}

// Submit is a paid mutator transaction binding the contract method 0x5b1ce5e1.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, (bytes,bytes,bytes) _leafBytes, uint256 _beefyMMRLeafIndex, uint256 _beefyMMRLeafCount, bytes32[] _beefyMMRLeafProof) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelTransactorSession) Submit(_messages []IncentivizedInboundChannelMessage, _leafBytes IncentivizedInboundChannelLeafBytes, _beefyMMRLeafIndex *big.Int, _beefyMMRLeafCount *big.Int, _beefyMMRLeafProof [][32]byte) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.Contract.Submit(&_IncentivizedInboundChannel.TransactOpts, _messages, _leafBytes, _beefyMMRLeafIndex, _beefyMMRLeafCount, _beefyMMRLeafProof)
}
