...
// Submit is a paid mutator transaction binding the contract method 0x1289d5d9.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, (bytes,bytes,bytes) _leafBytes, (bytes32[],uint64) proof) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelTransactor) Submit(opts *bind.TransactOpts, _messages []IncentivizedInboundChannelMessage, _leafBytes IncentivizedInboundChannelLeafBytes, proof SimplifiedMMRProof) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.contract.Transact(opts, "submit", _messages, _leafBytes, proof)
}

// Submit is a paid mutator transaction binding the contract method 0x1289d5d9.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, (bytes,bytes,bytes) _leafBytes, (bytes32[],uint64) proof) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelSession) Submit(_messages []IncentivizedInboundChannelMessage, _leafBytes IncentivizedInboundChannelLeafBytes, proof SimplifiedMMRProof) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.Contract.Submit(&_IncentivizedInboundChannel.TransactOpts, _messages, _leafBytes, proof)
}

// Submit is a paid mutator transaction binding the contract method 0x1289d5d9.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, (bytes,bytes,bytes) _leafBytes, (bytes32[],uint64) proof) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelTransactorSession) Submit(_messages []IncentivizedInboundChannelMessage, _leafBytes IncentivizedInboundChannelLeafBytes, proof SimplifiedMMRProof) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.Contract.Submit(&_IncentivizedInboundChannel.TransactOpts, _messages, _leafBytes, proof)
}
