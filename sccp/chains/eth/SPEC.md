...
## ETH Burn Event Proof Target

Canonical outbound `ETH -> SORA` burn proof target:
...
- log address equals the configured router address for the source EVM domain,
...
- decoded `payload.source_domain` matches the router local domain.
