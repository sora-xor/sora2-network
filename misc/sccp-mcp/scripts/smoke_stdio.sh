...
req_tools_list='{"jsonrpc":"2.0","id":2,"method":"tools/list","params":{}}'
req_list_networks='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"sccp_list_networks","arguments":{}}}'
req_message_id='{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"sccp_get_message_id","arguments":{"payload":{"version":1,"source_domain":0,"dest_domain":1,"nonce":42,"sora_asset_id":"0x1111111111111111111111111111111111111111111111111111111111111111","amount":"1000000000000000000","recipient":"0x0000000000000000000000002222222222222222222222222222222222222222"}}}}'
