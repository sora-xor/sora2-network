...
pub const EXCHANGE: PermissionId = 2;
pub const MINT: PermissionId = 3;
pub const BURN: PermissionId = 4;
pub const SLASH: PermissionId = 5;
pub const INIT_DEX: PermissionId = 6;
pub const MANAGE_DEX: PermissionId = 7;
pub const CREATE_FARM: PermissionId = 8;
pub const CHECK_FARM: PermissionId = 9;
pub const INVEST_TO_FARM: PermissionId = 10;
pub const CLAIM_FROM_FARM: PermissionId = 11;
