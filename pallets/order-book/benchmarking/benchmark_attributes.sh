...
mkdir benches
bench_names=( place_limit_order_without_cross_spread_ cancel_limit_order_first_ cancel_limit_order_last_ execute_market_order_ quote_ exchange_single_order_ )
