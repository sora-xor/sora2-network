...
fn to_ethabi_h160(value: H160) -> ethabi::ethereum_types::H160 {
    ethabi::ethereum_types::H160::from_slice(value.as_bytes())
}

fn to_ethabi_u256(value: U256) -> ethabi::ethereum_types::U256 {
    let bytes = value.to_big_endian();
    ethabi::ethereum_types::U256::from_big_endian(&bytes)
}
...
impl<MaxMessages: Get<u32>, MaxPayload: Get<u32>> OutboundCommitment<MaxMessages, MaxPayload> {
    pub fn hash(&self) -> H256 {
        ...
        let messages: Vec<Token> = self
            ...
            .map(|message| {
                Token::Tuple(vec![
                    Token::Address(to_ethabi_h160(message.target)),
                    Token::Uint(to_ethabi_u256(message.max_gas)),
        ...
        let commitment: Vec<Token> = vec![
            ...
            Token::Uint(to_ethabi_u256(self.total_max_gas)),
        ...
        crate::h256_from_sp_core(sp_runtime::traits::Keccak256::hash(&input))
    }
}
...
impl<MaxPayload: Get<u32>> codec::DecodeWithMemTracking for Message<MaxPayload> {}
impl<MaxMessages: Get<u32>, MaxPayload: Get<u32>> codec::DecodeWithMemTracking
    for Commitment<MaxMessages, MaxPayload>
{
}
impl<MaxMessages: Get<u32>, MaxPayload: Get<u32>> codec::DecodeWithMemTracking
    for OutboundCommitment<MaxMessages, MaxPayload>
{
}
impl<MaxPayload: Get<u32>> codec::DecodeWithMemTracking for InboundCommitment<MaxPayload> {}
impl<MaxMessages: Get<u32>> codec::DecodeWithMemTracking for StatusReport<MaxMessages> {}
