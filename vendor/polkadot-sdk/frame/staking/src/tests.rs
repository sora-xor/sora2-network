...
fn change_of_absolute_max_nominations() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute(|| {
            ...
            assert_eq!(
                Staking::electing_voters(bounds, SINGLE_PAGE,)
                    .unwrap()
                    .len(),
                3 + 3
            );
