...
impl AdditionalPayout<AccountId> for MockAdditionalPayout {
    ...
    fn weight(nominators: u32) -> Weight {
        if !sp_io::storage::exists(ADDITIONAL_PAYOUT_MODE) {
            return Weight::zero();
        }
        Weight::from_parts(10_000, 100)
            .saturating_add(Weight::from_parts(1_000, 10).saturating_mul(nominators.into()))
    }
}
...
impl crate::pallet::pallet::Config for Test {
    ...
    type AdditionalPayout = MockAdditionalPayout;
