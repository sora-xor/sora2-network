...
- Official email: confirm before submit. The legacy Etherscan listing uses `sora@soramitsu.co.jp`.
...
Etherscan's current guideline asks for SVG 32x32 or PNG 64x64.

- Prepared 64x64 PNG for upload: `runtime-upgrade-4.8.7/etherscan-xor-logo-64.png`
- SHA-256: `1d37b30db018daf26b043d009b22be1e1b585ec1c83b9f68ead29dcd4ecc1ffe`
...
If Etherscan requires a public 64x64 logo URL instead of a file upload, upload `etherscan-xor-logo-64.png` to an official public SORA/SORAMITSU location first and use that URL.
...
6. Upload `etherscan-xor-logo-64.png` or provide an official public URL for the same file.
